...
function ContactSection() {
  return (
    <section id="contact" className="w-full max-[680px]:h-auto h-[350px] flex max-[680px]:flex-col-reverse items-center justify-between gap-4 max-[480px]:px-2 max-[860px]:px-4 px-12 mb-10">
